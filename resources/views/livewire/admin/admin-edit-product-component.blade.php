            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="" class="form" wire:submit.prevent='updateProduct'>
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="row" style="margin-top: 10px">
                                    <div class="col-md-6">
                                        ...
                                        @if($newImage)
                                            <img src="{{$newImage->temporaryUrl()}}" alt="Product Image" width="120px">
                                            @else
                                ...
                                <div class="form-group" style="margin-top: 3rem; ">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <button style="padding: 10px 20px" type="submit" class="btn btn-primary"> Update Product</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
